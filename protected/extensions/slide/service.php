...
class SlideService
{
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS `{tablePrefix}ext_slide_show` (
        ...
        $sql .= "CREATE TABLE IF NOT EXISTS `{tablePrefix}ext_slide_show_category` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
        ...
        INSERT INTO `{tablePrefix}ext_slide_show_category` (`id`, `title`, `description`, `configs`, `created_at`, `updated_at`) VALUES
